...
class TestLinterFunctions(TestCase):
    ...
    def test_ignore_migration_include_apps(self):
        ...
        self.assertFalse(linter.should_ignore_migration('app_add_not_null_column', '0001'))
    ...
    def test_ignore_migration_exclude_apps(self):
        ...
        self.assertTrue(linter.should_ignore_migration('app_add_not_null_column', '0001'))
