"""
Django settings for test_project_drop_column project.
...
ROOT_URLCONF = 'test_project_drop_column.urls'
...
WSGI_APPLICATION = 'test_project_drop_column.wsgi.application'
